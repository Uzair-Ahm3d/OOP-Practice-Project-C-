...
void displayLogo()
{
    ...
    cout << "                            Welcome to VIBE STREAM! Your music journey starts here." << endl;
    cout << "                                 Enjoy exploring and managing your playlists." << endl;
    cout << "                                          Let's create some vibes!" << endl << endl;
...
int main()
{
    ...
    loadingAnimation("Welcome to your Vibe Stream");
    delay(1000);
    clearScreen();
